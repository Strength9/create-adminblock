...
exports.acfBlock = function() {
    ...
    console.clear();
    console.log('Create Admin Block is running...');
    console.log('');
    console.log('This will create a new folder in the current directory containing scaffolding for a new WordPress Admin Block.');
    console.log('');
